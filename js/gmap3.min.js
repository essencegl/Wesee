...
(function(y, t) {
        ...
        if (L.todo.events || L.todo.onces) {
            ...
            if (L.todo.events) {
                ...
                function(R, U) {
                    ...
                    google.maps.event.addListener(N, R,
                    function(V) {
                        S.apply(T, [O ? O: N, V, M])
                    })
                })
            ...
            if (L.todo.onces) {
                ...
                function(R, U) {
                    ...
                    google.maps.event.addListenerOnce(N, R,
                    function(V) {
                        S.apply(T, [O ? O: N, V, M])
                    })
                })
    ...
    function e(Q, P, O, L) {
        ...
        this.onAdd = function() {
            ...
            function(T, S) {
                M.push(google.maps.event.addDomListener(L[0], S,
                function(U) {
            ...
            M.push(google.maps.event.addDomListener(L[0], "contextmenu",
            function(S) {
    ...
    function F(ae, ao, aa) {
        ...
        function S() {
            ...
            Z = true;
            N.push(google.maps.event.addListener(ao, "zoom_changed",
            function() {
                al()
            }));
            N.push(google.maps.event.addListener(ao, "bounds_changed",
            function() {
                al()
            }));
            ag()
    ...
    function K(T) {
        ...
        function L(aa, Y) {
            ...
            if (N) {
                ...
                var Z = Y.opts || y.extend(true, {},
                z.map, Y.todo && Y.todo.options ? Y.todo.options: {});
        ...
        this.marker = function(aa) {
            ...
            if (aa.todo.cluster && !N.getBounds()) {
                google.maps.event.addListenerOnce(N, "bounds_changed",
                function() {
                    S.marker.apply(S, [aa])
                });
                return
        ...
        this.exec = function(Y) {
            var Z = this;
            y.each(g(Y.todo.func),
            function(aa, ab) {
                y.each(Z.get(Y.todo, true, Y.todo.hasOwnProperty("full") ? Y.todo.full: true),
                function(ac, ad) {
                    ab.call(T, ad)
                })
            });
